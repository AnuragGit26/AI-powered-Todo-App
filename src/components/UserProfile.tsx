...
const UserProfile: React.FC<UserProfileProps> = () => {
    ...
    return (
        <div className="min-h-screen bg-black bg-opacity-90 p-4 md:p-8">
            <div className="max-w-4xl mx-auto rounded-xl bg-transparent dark:bg-transparent shadow-2xl overflow-hidden">
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <Button onClick={handlePasswordChange} disabled={isLoading} className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700">
                                        {isLoading ? <Loader /> : "Save password"}
                                    </Button>
                                    {passwordError && (
